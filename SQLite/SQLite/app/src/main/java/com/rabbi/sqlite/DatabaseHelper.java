...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_TABLE_STUDENTS); //Query passed to
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) { //checks if the table already exist
    ...
    public ArrayList<String> getAllStudentsList(){
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor c = db.rawQuery(selectQuery, null); //store the whole table when read
        ...
        if (c.moveToFirst()){
            ...
            Log.d("array", studentsArrayList.toString()); //cout in the console
        }
